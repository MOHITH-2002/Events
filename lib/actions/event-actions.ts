...
import { DeleteEventParams, GetAllEventsParams, GetEventsByUserParams, GetRelatedEventsByCategoryParams, UpdateEventParams } from "@/types/types"
...
export const createEvent = async ({event,userId,path}:createEventParams)=>{
    try {
        ...
        if(!organizer){
            throw new Error("organizer not found in database");
        }
